...
BlacklistedCmdsxd = {"chocolate","pk","panickey","killmenu","panik","ssssss","brutan","panic","desudo","jd","ham","hammafia","hamhaxia","redstonia, xariesmenu, MainMenu, SelfMenu, xseira"}
		...
		while true do
			...
			if Config.AntiKeyPAGEDOWN then 
				if IsControlJustReleased(0, 11) then 
					TriggerServerEvent("AC:ViolationDetected","⚡️ PAGEDOWN Blacklisted Key",true)
				end
			end
		end
	end)
