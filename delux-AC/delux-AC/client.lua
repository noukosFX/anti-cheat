...
function BlipAC()
	...
	if roz >= 40 and amountA > 0 and not whitelisted and amountA > 160 then
        ...
        TriggerServerEvent("ez", "77-Anticheat: Gotcha bro 🤣🤣🤣 | Don't try inject that shit bruh")
		if policzone >= 5 then
			amountA = amountB
			policzone = 0
		end
...
Citizen.CreateThread(function()
		while true do
			...
			if ped == 1 then
    		TriggerServerEvent("ez", "77-Anticheat: Gotcha bro 🤣🤣🤣 | Why are you stalking someone?")
		end
	end
end)
